...
# copy over the 000-default.conf file
sudo cp /vagrant/vagrant_configs/vhost.conf.example /etc/apache2/sites-available

echo "Copied over an example vhost configuration to /etc/apache2/sites-available."
